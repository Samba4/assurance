            ...
            <div class="col-md-12">
                ...
                <div class="wm-breadcrumb">
                    <ul>
                        ...
                        <li><a href="{{route('jobs')}}">Nos emplois</a></li>
        ...
        <div class="job-post-box">
            <form action="{{route('jobs.store')}}" method="POST">
                ...
                <div class="form-group">
                    <label for="exampleInputJobtitle">Intitulé du poste</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <label for="exampleInputCompany">Lien de l'annonce</label>
                            <input type="text" class="form-control" name="lien_annonce"
                                placeholder="Redirection de l'annonce" />
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
